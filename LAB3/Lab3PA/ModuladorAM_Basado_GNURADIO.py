...
# Author: Carlos_221729_Daniel_2202812
# Copyright: UIS
...
class ModuladorAM_Basado_GNURADIO(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModuladorAM_Basado_GNURADIO")
...
def main(top_block_cls=ModuladorAM_Basado_GNURADIO, options=None):
