...
# Author: Carlos_221729_Juan_2215585
# Copyright: UIS
...
from ModuladorAM_CARLOS_DANIEL import ModuladorAM_CARLOS_DANIEL  # grc-generated hier_block
...
class Modulador_AM_Basado_GNURADIO(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Modulador_AM_Basado_GNURADIO")
        ...
        self._Fm_win = RangeWidget(self._Fm_range, self.set_Fm, "Frecuencia Mensage", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Fm_win)
        self._Am_range = Range(0, 5, 0.01, 0.25, 200)
        self._Am_win = RangeWidget(self._Am_range, self.set_Am, "Amplitud Mensage", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.ModuladorAM_CARLOS_DANIEL_0 = ModuladorAM_CARLOS_DANIEL(
            Ac=Ac,
            ka=KA,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.ModuladorAM_CARLOS_DANIEL_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.ModuladorAM_CARLOS_DANIEL_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.ModuladorAM_CARLOS_DANIEL_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ModuladorAM_CARLOS_DANIEL_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModuladorAM_CARLOS_DANIEL_0, 0))
    ...
    def set_KA(self, KA):
        self.KA = KA
        self.ModuladorAM_CARLOS_DANIEL_0.set_ka(self.KA)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.ModuladorAM_CARLOS_DANIEL_0.set_Ac(self.Ac)




def main(top_block_cls=Modulador_AM_Basado_GNURADIO, options=None):
